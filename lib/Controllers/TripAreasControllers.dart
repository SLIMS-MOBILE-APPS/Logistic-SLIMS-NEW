...
class TripAreasAPIController {
  static Future<List<TripAreasModels>> fetchTripAreasDataAPIs({
    ...
    required String ipRouteShiftId,
    ...
    final Map<String, String> data = {
      "IP_ROUTE_ID": "${ipRouteMapId + "_" + ipRouteShiftId}", //"17_4149",
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (responseData['status'] != "201") {
          throw Exception(
              "API responded with status: ${responseData['status']}");
        }
        ...
        throw Exception(
            'Failed to fetch TripRouteDetails Data: HTTP ${response.statusCode}');
      }
    } catch (e) {
